...
NotebookDataLength[     88262,       1889]
NotebookOptionsPosition[     61485,       1303]
NotebookOutlinePosition[     87795,       1865]
CellTagsIndexPosition[     87684,       1859]
WindowTitle->Illustrating the Central Limit Theorem with Sums of Bernoulli \
Random Variables
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`n$$ = 1, $CellContext`p$$ = 0.5, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
      Hold[$CellContext`n$$], 1, 1000, 1}, {{
       Hold[$CellContext`p$$], 0.5}, 0.05, 0.95, 0.05}}, Typeset`size$$ = {
    500., {148., 152.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = True, $CellContext`n$748$$ = 
    0, $CellContext`p$749$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`n$$ = 1, $CellContext`p$$ = 0.5}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$748$$, 0], 
        Hold[$CellContext`p$$, $CellContext`p$749$$, 0]}, 
      "OtherVariables" :> {
      ...
      "Body" :> ($CellContext`s = 
        Sqrt[($CellContext`p$$ (
            1 - $CellContext`p$$)) $CellContext`n$$]; $CellContext`xy = 
        Table[{($CellContext`k - $CellContext`n$$ \
$CellContext`p$$)/$CellContext`s, 
           PDF[
            
            BinomialDistribution[$CellContext`n$$, $CellContext`p$$], \
$CellContext`k]}, {$CellContext`k, 0, $CellContext`n$$}]; $CellContext`y = 
        Map[Last, $CellContext`xy]; $CellContext`x = 
        Map[First, $CellContext`xy]; $CellContext`xmin = $CellContext`x - 1/(
         2 $CellContext`s); $CellContext`xmax = $CellContext`x + 
         1/(2 $CellContext`s); $CellContext`ymax = $CellContext`y \
$CellContext`s; $CellContext`r = 
        MapThread[Rectangle[{#, #2}, {#3, #4}]& , {$CellContext`xmin, 
           Array[
           0& , $CellContext`n$$ + 1], $CellContext`xmax, $CellContext`ymax}]; 
       Plot[
         PDF[
          NormalDistribution[0, 1], $CellContext`z], {$CellContext`z, -4, 4}, 
         Axes -> False, Frame -> True, PlotPoints -> 100, PlotStyle -> {Red, 
           Thickness[Large]}, PlotRange -> All, Epilog -> {
           EdgeForm[
            Directive[Thin, Dashed, Blue]], LightGray, 
           Opacity[0.5], $CellContext`r}, ImageSize -> {500, 300}]), 
      "Specifications" :> {{$CellContext`n$$, 1, 1000, 1, Appearance -> 
         "Labeled"}, {{$CellContext`p$$, 0.5}, 0.05, 0.95, 0.05, Appearance -> 
         "Labeled"}}, 
      "Options" :> {TrackedSymbols :> {$CellContext`n$$, $CellContext`p$$}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{547., {206., 211.}},
...
Cell[TextData[{
 "Consider the central limit theorem for independent Bernoulli random \
variables ",
 Cell[BoxData[
  FormBox[
   RowBox[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"0", "<", "p", "<", "1"}], TraditionalForm]], "InlineMath"],
 ". Then the sum ",
 Cell[BoxData[
  FormBox[
 ...
 Cell[BoxData[
  ...
  "InlineMath"],
 " converges in distribution to the standard normal. The exact distribution \
for ",
 Cell[BoxData[
  FormBox[
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["z", "k"], TraditionalForm]], "InlineMath"],
 ". As ",
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 " increases, the rectangles closely approach the standard normal density \
function. The convergence is faster in the symmetric case when ",
 Cell[BoxData[
  FormBox[
   RowBox[{"p", "=", 
...
Cell[TextData[{
 ButtonBox["Binomial Distribution",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/BinomialDistribution"], None},
  ButtonNote->"http://demonstrations.wolfram.com/BinomialDistribution"],
 " (",
...
Cell[TextData[{
 ButtonBox["Successes and Failures in a Run of Bernoulli Trials",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
SuccessesAndFailuresInARunOfBernoulliTrials/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
SuccessesAndFailuresInARunOfBernoulliTrials/"],
 " (",
 ButtonBox["Wolfram Demonstrations Project",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 StyleBox[ButtonBox["Mathematica",
  ...
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
Mathematica7sDiscreteDistributions"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/Mathematica7sDiscreteDistributions"],
  FontSlant->"Italic"],
 ButtonBox[" 7\[CloseCurlyQuote]s Discrete Distributions",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
Mathematica7sDiscreteDistributions"], None},
...
Cell[TextData[{
 ButtonBox["The de Moivre-Laplace Theorem in Probability Theory",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
...
IllustratingTheCentralLimitTheoremWithSumsOfBernoulliRandomV&version=0009"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
IllustratingTheCentralLimitTheoremWithSumsOfBernoulliRandomV/\
IllustratingTheCentralLimitTheoremWithSumsOfBernoulliRandomV-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Illustrating the Central Limit Theorem with Sums of Bernoulli \
Random Variables",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
IllustratingTheCentralLimitTheoremWithSumsOfBernoulliRandomV/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
IllustratingTheCentralLimitTheoremWithSumsOfBernoulliRandomV/"],
 "\"",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[42599, 803, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[42860, 812, 4480, 99, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[60663, 1278, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 87397, 1848},
 {"Copyright", 87592, 1853}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1557, 35, 34328, 567, 70, "DemonstrationHeader"],
Cell[35888, 604, 107, 2, 70, "DemoTitle"],
Cell[35998, 608, 3101, 63, 70, "Output",
 CellID->29089976],
Cell[39102, 673, 3494, 128, 70, "ManipulateCaption"],
Cell[42599, 803, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[42860, 812, 4480, 99, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[47343, 913, 44, 0, 70, "RelatedLinksSection"],
Cell[47390, 915, 485, 14, 70, "RelatedLinks",
 CellID->966241568],
Cell[47878, 931, 572, 17, 70, "RelatedLinks",
 CellID->1049803511],
Cell[48453, 950, 824, 24, 70, "RelatedLinks",
 CellID->350694762],
Cell[49280, 976, 648, 18, 70, "RelatedLinks",
 CellID->487100570],
Cell[49931, 996, 604, 17, 70, "RelatedLinks",
 CellID->1842895885],
Cell[50538, 1015, 623, 18, 70, "RelatedLinks",
 CellID->394498514],
Cell[51164, 1035, 573, 17, 70, "RelatedLinks",
 CellID->1054506509],
Cell[51740, 1054, 574, 17, 70, "RelatedLinks",
 CellID->2055841719],
Cell[52317, 1073, 494, 14, 70, "RelatedLinks",
 CellID->1431737566],
Cell[52814, 1089, 652, 21, 70, "RelatedLinks",
 CellID->1359530577],
Cell[53469, 1112, 654, 21, 70, "RelatedLinks",
 CellID->1247850173],
Cell[54126, 1135, 4928, 92, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[59057, 1229, 45, 0, 70, "CitationSection"],
Cell[59105, 1231, 378, 12, 70, "Author",
 CellID->231450238],
Cell[59486, 1245, 1174, 31, 70, "Citations"],
Cell[60663, 1278, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature PQU8udmIY2rjAu7wOA7Tkru# *)
