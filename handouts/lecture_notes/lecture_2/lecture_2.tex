...
real line, as illustrated in Figure \ref{fig:org29a2e7d}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figure/random_variable_demo1.png}
\caption{\label{fig:org29a2e7d}
...
Table \ref{tab:org65787c1} and Figure \ref{fig:org1d33fa5} show that the
c.d.f. of a discrete random variable is a step function of \(x\).

\begin{table}[htbp]
\caption{\label{tab:org65787c1}
...
Figure \ref{fig:orgecd6f5f}\footnote{Source of Figure \ref{fig:orgecd6f5f}: Pishro-Nik, Hossein. (2017). Introduction to
...
\label{sec:orgfcbd3d7}

\begin{itemize}
\item Definition
\label{sec:orgedd86d3}
...
\label{sec:org24bf06a}

\subsubsection*{Covariance}
\label{sec:org19137e1}
