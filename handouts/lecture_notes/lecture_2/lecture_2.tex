...
real line, as illustrated in Figure \ref{fig:org2d25749}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figure/random_variable_demo1.png}
\caption{\label{fig:org2d25749}
...
Table \ref{tab:org0ae7d3f} and Figure \ref{fig:org83af35e} show that the
c.d.f. of a discrete random variable is a step function of \(x\).

\begin{table}[htbp]
\caption{\label{tab:org0ae7d3f}
...
Figure \ref{fig:org1b04d59}\footnote{Source of Figure \ref{fig:org1b04d59}: Pishro-Nik, Hossein. (2017). Introduction to
...
\label{sec:org1a2e9e7}

\begin{itemize}
\item Definition
\label{sec:org3bc57df}
...
\label{sec:orgcea324d}

\subsubsection*{Covariance}
\label{sec:org33c2b71}
