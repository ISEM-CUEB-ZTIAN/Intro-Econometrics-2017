...
real line, as illustrated in Figure \ref{fig:orgf3d562c}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figure/random_variable_demo1.png}
\caption{\label{fig:orgf3d562c}
...
Table \ref{tab:org98d5510} and Figure \ref{fig:org58ef1af} show that the
c.d.f. of a discrete random variable is a step function of \(x\).

\begin{table}[htbp]
\caption{\label{tab:org98d5510}
...
Figure \ref{fig:orgc464ff1}\footnote{Source of Figure \ref{fig:orgc464ff1}: Pishro-Nik, Hossein. (2017). Introduction to
...
\label{sec:org86502f8}

\begin{itemize}
\item Definition
\label{sec:orgb5a59db}
...
\label{sec:org78978bf}

\subsubsection*{Covariance}
\label{sec:orgc067b7f}
...
\label{sec:org627116a}

\subsubsection*{Definition}
\label{sec:org682be58}
...
equal 3. Figure \ref{fig:org79375a3} displays the probability density of a
normal distribution.\footnote{Source of Figure \ref{fig:org79375a3}: Characteristics of the
...
\label{sec:orgb22a2fa}

\subsection{Random sampling}
\label{sec:org7408458}
...
\label{sec:org58184e7}

\subsubsection*{The sample average}
\label{sec:org61998c0}
...
\label{sec:orgab82fc4}
\subsection{The law of large numbers}
\label{sec:org879d8f5}
\subsubsection*{Convergence in probability}
\label{sec:org9385208}
...
\label{sec:org80923c3}

\subsubsection*{Convergence in distribution}
\label{sec:org7e6c5ee}
