...
\label{sec:org4b60d6e}

\subsection*{Defining probabilities and random variables}
\label{sec:orgc04bf80}

\begin{frame}[label={sec:org3867c13}]{Experiments and outcomes}
\begin{itemize}
...
\begin{frame}[label={sec:org4c4be4a}]{Sample space and events}
\begin{itemize}
...
\label{sec:orgbd3f220}

\begin{frame}[label={sec:org2c66dcc}]{An intuitive definition of probability}
\begin{itemize}
...
\begin{frame}[label={sec:org3c5f1f5}]{An axiomatic definition of probability}
\begin{itemize}
...
\label{sec:org546ed4d}

\begin{frame}[label={sec:org361ff59}]{The definition of random variables}
\begin{itemize}
...
\begin{frame}[label={sec:orgd70433f}]{An illustration of random variables}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figure/random_variable_demo1.png}
\caption{\label{fig:org52eb491}
An illustration of random variable}
\end{figure}
\end{frame}

\begin{frame}[label={sec:orgd0f2dc7}]{Discrete and continuous random variables}
...
\label{sec:orgb0f4fa8}

\begin{frame}[label={sec:org916e8d1}]{The probability distribution for a discrete random variable}
\begin{itemize}
...
\begin{frame}[label={sec:orgd1fdd66}]{An example of the probability distribution of a discrete random variable}
\begin{table}[htbp]
\caption{\label{tab:orgc77ab18}
...
\label{sec:org91dcde3}

\begin{frame}[label={sec:org1c5afb1}]{Definition of the c.d.f.}
\begin{itemize}
...
\begin{frame}[label={sec:orge6517b9}]{An illustration of the c.d.f. of a discrete random variable}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.53\textwidth,height=0.45\textheight]{figure/cdf_discrete_example.png}
\caption{\label{fig:org73bd0da}
The c.d.f. of a discrete random variable}
\end{figure}
\end{frame}

\begin{frame}[label={sec:org0d8daae}]{Bernouli distribution}
...
\label{sec:org2feeee3}

\begin{frame}[label={sec:org3fb03e9}]{Definition of the c.d.f. and the p.d.f.}
\begin{itemize}
...
\begin{frame}[label={sec:org5bf4e29}]{Properties of the c.d.f.}
\begin{itemize}
...
\begin{frame}[label={sec:orga0626a5}]{The c.d.f. and p.d.f. of a normal distribution}
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\textwidth,height=0.5\textheight]{figure/norm1.png}
\caption{\label{fig:orgeb0747a}
...
\label{sec:org4f061d5}

\subsection*{The expected value of a random variable}
\label{sec:orgf5a23e0}

\begin{frame}[label={sec:orgb4d5ce1}]{The expected value}
\begin{itemize}
...
\begin{frame}[label={sec:orgf6613c6}]{Mathematical definition}
\begin{itemize}
...
\label{sec:org782d0b2}

\begin{frame}[label={sec:orgf8a3996}]{Definition of variance and standard deviation}
\begin{itemize}
...
\begin{frame}[label={sec:org87db8ad}]{Computing variance}
\begin{itemize}
...
\label{sec:orgb08a805}

\begin{frame}[label={sec:org7375631}]{Definition of the moments of a distribution}
\begin{description}
...
\begin{frame}[label={sec:orgceef61c}]{Skewness}
\begin{itemize}
...
\begin{frame}[label={sec:org28809b4}]{Kurtosis}
\begin{itemize}
...
\begin{frame}[label={sec:org7576312}]{An illustration of skewness and kurtosis}
\begin{center}
...
\label{sec:org4360b4b}

\begin{frame}[label={sec:org2b5e257}]{The joint and marginal distributions}
...
\begin{frame}[label={sec:org9338c2d}]{The marginal probability distribution}
\begin{itemize}
...
\begin{frame}[label={sec:org45c916f}]{An example of joint and marginal distributions}
\begin{table}[htbp]
\caption{\label{tab:org443d8ee}
...
\begin{frame}[label={sec:org7d732e9}]{Conditional probability}
\begin{itemize}
...
\begin{frame}[label={sec:orgdcf0456}]{The conditional probability distribution}
\begin{itemize}
...
\begin{frame}[label={sec:org587860a}]{The conditional expectation}
\begin{itemize}
...
\begin{frame}[label={sec:org8f33a4d}]{The law of iterated expectation}
\begin{itemize}
...
\begin{frame}[label={sec:orgb1f998b}]{Conditional variance}
\begin{itemize}
...
\begin{frame}[label={sec:org42e99b5}]{Independent random variables}
\begin{itemize}
...
\begin{frame}[label={sec:org87fec50}]{Independence between two continuous random variable}
\begin{itemize}
...
\label{sec:org6ca4251}

\begin{frame}[label={sec:orga322059}]{Covariance}
\begin{itemize}
...
\begin{frame}[label={sec:orgc71aa20}]{Correlation coefficient}
\begin{itemize}
...
\begin{frame}[label={sec:org12320cd}]{Independence and uncorrelation}
\begin{itemize}
...
\begin{frame}[label={sec:org7938250}]{Conditional mean and correlation}
\begin{itemize}
...
\begin{frame}[label={sec:org6db2eac}]{Some useful operations}
The following properties
