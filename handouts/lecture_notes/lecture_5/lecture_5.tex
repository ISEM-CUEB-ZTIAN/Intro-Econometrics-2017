...
\label{sec:org0ddb1dd}

\subsection{What is R?}
\label{sec:org9ea6803}
...
\label{sec:org19a722b}

\subsubsection*{Install R}
\label{sec:org23531dc}
...
\item The window of RStudio looks like Figure \ref{fig:org3382e27}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figure/rstudio.png}
\caption{\label{fig:org3382e27}
...
\subsection{Matrices}
\label{sec:orgf9c0d57}

\subsubsection*{Create a matrix}
\label{sec:org810823b}
...
\label{sec:org1916de0}

\subsubsection*{Question (a)}
\label{sec:org55cb8e5}
