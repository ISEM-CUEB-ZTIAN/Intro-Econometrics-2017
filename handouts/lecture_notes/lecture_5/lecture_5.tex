...
\label{sec:org1dda0a4}

\subsection{What is R?}
\label{sec:org0cddf9f}
...
\label{sec:orgb05d691}

\subsubsection*{Install R}
\label{sec:org40c2931}
...
\item The window of RStudio looks like Figure \ref{fig:orgbae8247}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figure/rstudio.png}
\caption{\label{fig:orgbae8247}
...
\subsection{Matrices}
\label{sec:org22846ac}

\subsubsection*{Create a matrix}
\label{sec:org1c96d1d}
...
\label{sec:orgf27089d}

\subsubsection*{Question (a)}
\label{sec:orga0118a4}
