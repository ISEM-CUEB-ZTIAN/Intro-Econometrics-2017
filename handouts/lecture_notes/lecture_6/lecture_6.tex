...
\label{sec:org4bb1442}
\subsubsection*{The predicted values}
\label{sec:org5adfc74}
...
\label{sec:orga01dfc0}

\begin{itemize}
\item Basic summary statistics
\label{sec:org0208472}
...
quantile (percentile), etc. Table \ref{tab:org01579f8} summarizes the
distribution of test scores and class sizes for the sample.

\begin{table}[htbp]
\caption{\label{tab:org01579f8}
...
form a regression model should properly take. Figure \ref{fig:org28da0fd}
...
\label{sec:org4691077}

\subsection{Goodness of Fit: R\(^{\text{2}}\)}
\label{sec:org487ccc6}
...
\label{sec:org39961de}

\begin{itemize}
\item \(R^2 \in [0, 1]\)
\label{sec:org9cbec34}
...
Assumption 1 can be illustrated by Figure \ref{fig:org70dc00d}. The conditional
...
\label{sec:orgd1dd7e0}

\begin{itemize}
\item An outlier can be detected by a scatterplot. See Figure \ref{fig:orgaff224c}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figure/fig-4-5.png}
\caption{\label{fig:orgaff224c}
