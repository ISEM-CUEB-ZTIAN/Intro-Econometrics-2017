...
\label{sec:orgca8227c}
\subsubsection*{The predicted values}
\label{sec:org3875285}
...
\label{sec:orgafe18d3}

\begin{itemize}
\item Basic summary statistics
\label{sec:orgeabfd88}
...
quantile (percentile), etc. Table \ref{tab:orge25d385} summarizes the
distribution of test scores and class sizes for the sample.

\begin{table}[htbp]
\caption{\label{tab:orge25d385}
...
form a regression model should properly take. Figure \ref{fig:org5d4ac8b}
...
\label{sec:org4ed9b3f}

\subsection{Goodness of Fit: R\(^{\text{2}}\)}
\label{sec:orgb51578a}
...
Assumption 1 can be illustrated by Figure \ref{fig:orged81adc}. The conditional
...
\label{sec:orgb42df8f}

\begin{itemize}
\item An outlier can be detected by a scatterplot. See Figure \ref{fig:org7a1f256}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figure/fig-4-5.png}
\caption{\label{fig:org7a1f256}
