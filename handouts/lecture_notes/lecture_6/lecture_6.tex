...
\label{sec:org77f26ec}
\subsubsection*{The predicted values}
\label{sec:org6dc039b}
...
\label{sec:org8c43c14}

\begin{itemize}
\item Basic summary statistics
\label{sec:orgb6e5055}
...
quantile (percentile), etc. Table \ref{tab:org6db54aa} summarizes the
distribution of test scores and class sizes for the sample.

\begin{table}[htbp]
\caption{\label{tab:org6db54aa}
...
form a regression model should properly take. Figure \ref{fig:org84c26ad}
...
\label{sec:org6758d5f}

\subsection{Goodness of Fit: R\(^{\text{2}}\)}
\label{sec:orgad73bc0}
...
Assumption 1 can be illustrated by Figure \ref{fig:org3e028ea}. The conditional
...
\label{sec:org4c40b3f}

\begin{itemize}
\item An outlier can be detected by a scatterplot. See Figure \ref{fig:org9d207d1}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figure/fig-4-5.png}
\caption{\label{fig:org9d207d1}
