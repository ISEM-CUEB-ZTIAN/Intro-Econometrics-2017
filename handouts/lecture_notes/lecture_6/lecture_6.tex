...
\label{sec:orgbc75aba}
\subsubsection*{The predicted values}
\label{sec:orgfb6a12d}
...
\label{sec:orgfac39b4}

\begin{itemize}
\item Basic summary statistics
\label{sec:org241a6ef}
...
quantile (percentile), etc. Table \ref{tab:org944722a} summarizes the
distribution of test scores and class sizes for the sample.

\begin{table}[htbp]
\caption{\label{tab:org944722a}
...
form a regression model should properly take. Figure \ref{fig:orgab59456}
...
\label{sec:org53c0f8a}

\subsection{Goodness of Fit: R\(^{\text{2}}\)}
\label{sec:orgedfde86}
...
Assumption 1 can be illustrated by Figure \ref{fig:org9abe1b2}. The conditional
...
\label{sec:org701a849}

\begin{itemize}
\item An outlier can be detected by a scatterplot. See Figure \ref{fig:org7c0ccc9}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figure/fig-4-5.png}
\caption{\label{fig:org7c0ccc9}
