...
\label{sec:org316647a}
\subsection*{Testing a single coefficient}
\label{sec:org16845b0}
...
\label{sec:org4169a2b}
\begin{itemize}
\item Zero restrictions
\label{sec:org7e0a95e}
...
% Date and time: Sun, May 14, 2017 - 22:06:08
