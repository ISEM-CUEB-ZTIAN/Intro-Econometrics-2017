...
\label{sec:org422b9a4}
\subsection*{Testing a single coefficient}
\label{sec:orgebb2af0}
...
\label{sec:org9a85398}
\begin{itemize}
\item Zero restrictions
\label{sec:orgd61ca0f}
...
% Date and time: Fri, May 12, 2017 - 14:19:03
