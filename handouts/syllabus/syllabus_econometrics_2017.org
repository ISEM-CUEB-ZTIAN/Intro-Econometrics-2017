...
- Homework will be assigned every other week. Homework will help
  ...
  applications.
- Questions of homework will be selected from the end-of-chapter
...
- Each homework set will be assigned on Tuesdays of odd weeks (except
  for Homework 1 assigned on Week 2), and
  *due at 12:00 am on Mondays* of the immediately following
  ...
  time to complete it.
- You can turn in your homework in class on Mondays or email to me
