...
\label{sec:org083a1e6}
\subsection*{Objectives}
\label{sec:org036fd48}
...
\section{Textbooks}
\label{sec:orge62c2e3}
\subsection*{Required}
\label{sec:org8b8affc}
...
\label{sec:orgd8258b5}
\subsection*{Lecture notes}
\label{sec:org2bfb210}
...
\label{sec:org94bb17e}
\subsection*{Homework}
\label{sec:org6b84a2f}
...
\label{sec:org83ccf1f}

Table \ref{tab:org72ce749} displays the tentative outline and schedule
