...
\label{sec:orge7f59ee}
\subsection*{Objectives}
\label{sec:orgff0883b}
...
\section{Textbooks}
\label{sec:orgc45788a}
\subsection*{Required}
\label{sec:org6c29752}
...
\label{sec:org2398afc}
\subsection*{Lecture notes}
\label{sec:orgf8e342c}
...
\label{sec:org0f1e32f}
\subsection*{Homework}
\label{sec:org606fde2}
...
\label{sec:org9254536}

Table \ref{tab:orgb2868f4} displays the tentative outline and schedule
