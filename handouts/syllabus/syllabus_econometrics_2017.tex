...
\label{sec:org3886e76}

\subsection*{Time and location}
\label{sec:org4e04b8b}
...
\label{sec:org962eb88}

\subsection*{Objectives}
\label{sec:orgfb87018}
...
\label{sec:org14db804}
\subsection*{Lecture notes}
\label{sec:orgaa9965b}
...
\label{sec:orgd5ff4e8}
\subsection*{Homework}
\label{sec:org8538ed6}
...
\label{sec:org8b49fbe}

Table \ref{tab:orgfff6e8f} displays the tentative outline and schedule
