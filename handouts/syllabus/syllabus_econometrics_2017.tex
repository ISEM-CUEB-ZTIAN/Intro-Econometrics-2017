...
\label{sec:org70de6cc}
\subsection*{Objectives}
\label{sec:orgc0812ac}
...
\section{Textbooks}
\label{sec:orgb519749}
\subsection*{Required}
\label{sec:org89ab030}
...
\label{sec:org9ca85ec}
\subsection*{Lecture notes}
\label{sec:orgb9d548d}
...
\label{sec:org44ac9d5}
\subsection*{Homework}
\label{sec:orgc9fadcb}
...
\label{sec:org25dcf10}

Table \ref{tab:org09ad187} displays the tentative outline and schedule
