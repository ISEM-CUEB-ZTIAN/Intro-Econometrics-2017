...
- The R file that contains all the code in the lecture notes ([[file:handouts/lecture_notes/lecture_5/lecture_5.R][R
  file]]).
- The Rmarkdown file that can generate a complete an answer to
  Empirical exercise 3.1 [[file:handouts/lecture_notes/lecture_5/mdfiles/emp_3_1.Rmd][Rmarkdown file]].
...
- Homework set #1 is here: [[file:assignment/homework/Homework_1.pdf][Homework_1.pdf]].
